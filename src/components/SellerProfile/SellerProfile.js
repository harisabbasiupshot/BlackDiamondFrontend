					...
					<div class="col-lg-3 col-md-4">
						<div class="dashboard-navbar">
							...
							<div class="d-user-avater">
								<img src={sellerprofile.profile_image?process.env.REACT_APP_PRODUCTION+sellerprofile.profile_image:"https://cdn-icons-png.flaticon.com/512/149/149071.png"}class="img-fluid avater" alt="" />
